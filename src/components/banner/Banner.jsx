   ...
   <section className='bg-[#bddadf] py-[70px] lg:py-[100px]  px-2'>
       <div className='max-w-[1320px] mx-auto '>
           <div>
               ...
               <p className='text-center md:text-[18px] lg:text-[20px] md:w-[600px] pb-10 font-dms  pt-5 lg:w-[900px] mx-auto'>I am a Frontend-focused Web Developer, building responsive and user-friendly websites and web applications that improve user experience and contribute to the overall success of the product.</p>
                <div className='text-center'>

               <button className='lg:py-4 py-4 rounded-[5px] hover:text-[#1E7EA7] duration-300  hover:bg-transparent border-transparent hover:border-[#1E7EA7] border-2 hover:border-2  lg:px-7 px-5   bg-[#1E7EA7] text-white font-bold font-san'>View My Project</button>
                </div>
           </div>
       </div>
